...
// ----------------------------------------------------------------------------
export const code = `<i class="far fa-file-code" style="color:#06620da1;padding-left:2px;"></i>`
export const gear = `<i class="fas fa-cog" style="color:#3979a7ba;"></i>`
export const google = `<i class="fab fa-google" style="color:#05830080;"></i>`
export const twitter = `<i class="fab fa-twitter" style="color:#1da1f2ba;"></i>`
export const facebook = `<i class="fab fa-facebook-square" style="color:#3b5998ba;"></i>`
