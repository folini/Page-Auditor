...
export class Errors {
    public static fromError(err: Error, optMsg: string = '') {
    ...
    public static unableToAnalyzeChromeTabs() {
    ...
    public static unableToAnalyzePage(url: string) {
    ...
    public static noMetaTagsInThisCategory(categoryName: string) {
    ...
    public static sitemapIsHTMLPage(url: string, code: string) {
    ...
    public static sitemapReturns404(url: string) {
    ...
    public static sitemapNotFound(urls: string[]) {
        const msg1 = `No <code>Sitemap.xml</code> file at location:`
    ...
    public static robotsTxtIsHTMLPage(url: string, code: string) {
    ...
    public static robotsTxtIsEmpty(url: string) {
    ...
    public static robotsTxtIsOnlyComments(url: string, code: string) {
    ...
    public static robotsTxtNotFound(url: string) {
    ...
    public static robotsTxtUnableToOpen(url: string, errorCode: number, errorMessage: string) {
    ...
    public static structuredDataNotFound(url: string) {
    ...
    public static unableToAddCardToReport() {
    ...
    public static invalidJSON(json: string) {
    ...
    public static noMetaTagsOnPage() {
