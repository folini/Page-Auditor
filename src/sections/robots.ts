...
import {siteMapCardsFromPromise, getRobotsTxtBody, robotsTxtCardFromPromise} from './robots-functions'
...
const reportGenerator: ReportGeneratorFunc = (tabUrl: string, _: any, report: Report): void => {
    ...
    robotsTxtCardFromPromise(robotsBodyPromise, robotsUrl, report)
    siteMapCardsFromPromise(robotsBodyPromise, sitemapUrl, report)
}
