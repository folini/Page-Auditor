...
export const injectableScript = (): iTracker[] => {
  const trackerTypes: iTracker[] = [
    ...
    },
    {
      ...
      name: "Twitter Ads and Analytics",
    ...
    },
    {
      ...
      name: "Google Ads (Search, Display, and Remarketing)",
    ...
    },
    {
      ...
      name: "LinkedIn Analytics &amp; Tracking",
    ...
    },
    {
      ...
      name: "Sophus3 Analytics (Automotive Industry)",
    ...
    },
    {
      ...
      name: "Drip Marketing Automation",
      iconClass: "icon-drip",
    ...
    },
    {
      ...
      name: "Qualtric (Experience Management)",
    ...
    },
    {
      ...
      name: "Channel Advisor Tracking",
      iconClass: "icon-channel-advisor",
      description: "ChannelAdvisor is a multichannel commerce platform whose mission is to connect and optimize the world's commerce. ChannelAdvisor helps brands and retailers worldwide improve their online performance by expanding sales channels, connecting with consumers across the entire buying cycle, optimizing their operations for peak performance, and providing actionable analytics to improve competitiveness.",
    ...
    },
    {
      ...
      description:
        "HubSpot is an American developer and marketer of software products for inbound marketing, sales, and customer service. Hubspot was founded by Brian and Dharmesh Shah in 2006.",
    ...
    {
      patterns: ["krxd.net/"],
      name: "Krux (SalesForce) Analytics",
    ...
    },
    {
      ...
      name: "Iubenda (Cookies and Privacy)",
    ...
    },
    {
      ...
      name: "Cookielaw (Cookies and Privacy)",
...
export const report = (trackersUntyped: any): string[] => {
  ...
  trackers
    ...
    .forEach((t, i) => {
      ...
      report.push(Card.open(`${t.name + link}`, `${t.iconClass}`))
      report.push(`<div class='track-description'>${t.description}</div>`)
      report.push(
